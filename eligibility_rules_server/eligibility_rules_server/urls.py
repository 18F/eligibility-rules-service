...
from rules_server.views import (RulesetSampleView, RulesetSchemaView,
                                RulesetSqlView, RulesetView, RulingsView)
...
urlpatterns = [
    ...
    path('rulings/<str:program>/<str:entity>/schema/',
         RulesetSchemaView.as_view()),
    path('rulings/<str:program>/<str:entity>/sample/',
         RulesetSampleView.as_view()),
    path('rulings/<str:program>/<str:entity>/sql/', RulesetSqlView.as_view()),

...
class Ruleset(models.Model):
    ...
    def report_from_rule_results(self, applicants, results):
        """Interpretation of results generated by `self.rule_results``
        ...
        for applicant in applicants:
            yield self._applicant_report_from_rule_results(
                applicant=applicant, results=results)

    def _applicant_report_from_rule_results(self, applicant, results):
